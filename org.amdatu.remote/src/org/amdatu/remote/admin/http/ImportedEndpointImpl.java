...
public final class ImportedEndpointImpl implements ImportRegistration, ImportReference, ClientEndpointProblemListener {
    ...
    public ImportedEndpointImpl(RemoteServiceAdminImpl admin, EndpointDescription description,
        ...
        try {
            // FIXME should have been checked before!!!
            Object serviceLocation = description.getProperties().get(ENDPOINT_URL);
            if (serviceLocation == null || !(serviceLocation instanceof String)) {
                throw new IllegalStateException();
            }
            URL serviceURL = new URL((String) serviceLocation);

            m_clientEndpoint = new HttpClientEndpointFactory(serviceURL, description.getInterfaces(), m_configuration);
