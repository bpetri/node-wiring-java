 ...
 * by {@link EndpointDiscoveryServlet} that may be added and removed over time.
 * 
 ...
 * 
 */
public final class EndpointDiscoveryPoller {
    ...
    private final DiscoveryConfiguration m_configuration;

    private volatile ScheduledFuture<?> m_future;

    public EndpointDiscoveryPoller(ScheduledExecutorService executor, AbstractDiscovery discovery,
    ...
    public void addDiscoveryEndpoint(URL url) {
        m_discovery.logDebug("add %s", url);
    ...
    public void removeDiscoveryEndpoint(URL url) {
        m_discovery.logDebug("rem %s", url);
    ...
    private final class EndpointHolder {
        ...
        public synchronized void update() {
            ...
            if (m_closed || !getUpdatedServicesIfModifiedSince()) {
                return;
            }
